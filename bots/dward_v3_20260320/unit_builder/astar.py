...
DIST_DIAG = 2**0.5
DIRECTION_D = [d.delta() for d in Direction if d != Direction.CENTRE]  # (dx,dy)
DIRECTION_D_CARD = [d.delta()
                    for d in [Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST]]
NON_BLOCKING_ENTITIES = [EntityType.CONVEYOR, EntityType.ROAD, EntityType.CORE]
